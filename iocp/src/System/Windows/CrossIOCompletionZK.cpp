                                             ...
                                             nuDWORD nMiniSeconds /* = nuINFINITE */)
{
    if( nuNULL == m_hIOCompletionPort )
    {
        LOG_ERROR_FILE("IO_QUEUE_STATUS_QUIT \n");
    ...
    else
    {
        ...
        {
            LOG_ERROR_FILE("IO_QUEUE_STATUS_TIMEOUT \n");
            return IO_QUEUE_STATUS_TIMEOUT;
        }
        else
        {
            PER_IO_OVERLAPPED *pPerOverlapped = *((PER_IO_OVERLAPPED**)ppOverlapped);
            pPerOverlapped->perSelf.nError = GetLastError();
            LOG_ERROR_FILE("IO_QUEUE_STATUS_FAILURE %d \n", pPerOverlapped->perSelf.nError);
